...
class RatingDonutView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet?=null): View(context, attributeSet) {
    ...
    private fun drawRating(canvas: Canvas){
        ...
        canvas.drawArc(oval, - 90f, converProgressToDegrees(progress), false, strokePaint)
        canvas.restore()
    }

    private fun converProgressToDegrees(progress: Int): Float = progress*3.6f
    ...
    private fun getPaintColor(progress: Int): Int = when(progress) {
        ...
        in 26..50 -> Color.parseColor("#fd8069")
